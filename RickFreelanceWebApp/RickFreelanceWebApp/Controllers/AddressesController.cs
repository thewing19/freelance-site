...
namespace RickFreelanceWebApp.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public AddressesController(FreelanceContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("AddressID,Street,City,State,PostalCode")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AddressID,Street,City,State,PostalCode")] Address address)
        {
